  ...
  return (
    <>
      <div className="place-items-center grid grid-cols-1 lg:grid-cols-2 h-screen font-bold">
        <div
          style={{ backgroundImage: `url("https://ik.imagekit.io/vzr6ryejm/carona/fundo_03.jpeg?updatedAt=1729796918917")` }}
        ...
        >
          ...
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              id="celular"
              name="celular"
              placeholder="Adicione o número do celular"
              className="border-2 border-slate-700 p-2 rounded"
          ...
          <div className="flex justify-around gap-8 w-full">
            ...
            <button
              type="submit"
              className="flex justify-center bg-cyan-600 hover:bg-cyan-900 py-2 rounded w-1/2 text-white"
            >
              {isLoading ? (
                <RotatingLines
                  strokeColor="white"
