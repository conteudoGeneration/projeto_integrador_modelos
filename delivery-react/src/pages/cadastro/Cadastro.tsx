  ...
  return (
    <>
      <div className="place-items-center grid grid-cols-1 lg:grid-cols-2 h-screen font-bold">
        <div
          style={{ backgroundImage: `url("https://ik.imagekit.io/vzr6ryejm/food/fundo06_2.jpeg?updatedAt=1729749014094")` }}
        ...
        >
          ...
          <div className="flex justify-around gap-8 w-full">
            ...
            <button
              type="submit"
              className="flex justify-center bg-teal-400 hover:bg-teal-700 py-2 rounded w-1/2 text-white"
            >
              {isLoading ? (
                <RotatingLines
                  strokeColor="white"
